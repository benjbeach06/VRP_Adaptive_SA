...
class SimAnnVRPSolver:
    def __init__(self, sln: FullSolution):
        ...
        self.cooling_factor = 0.9 # Factor per 100 iterations
    ...
    def update_weights(self):
        ...
        for op in self.operators:
            ...
            if num_uses > 0:
                ...
                op.weight = max(weight, (weight / geom_mean_weight) ** 0.8 * geom_mean_weight)
            op.reset_stats()
    ...
    def choose_operator(self):
        ...
        r = random.uniform(1, sum(cum_weights))

        index = bisect.bisect_left(cum_weights, r) - 1
        ...
        def add_next_route():
            ...
            if customers_remaining:
                ...
                while customers_remaining and can_add_route():
                    route.append_visit(next_customer)
    ...
    def solve(self):
        ...
        while elapsed_time < self.max_time:
            ...
            if accept:
                ...
                """
                if abs(improvement - (preop_obj - postop_obj)) >= 1e-6 or any(route.capacity_needed() != route.current_load for route in self.sln.all_routes):
            ...
            if not accept:
                ...
                op.revert()
                if abs(self.sln.solution_cost() - preop_obj) > 1e-6:
                    operands = op.prev_operands
                    ...
                    print(f"Reverted cost breakdown:" + str((self.sln.total_path_len(), self.sln.depots_used(), self.sln.vehicles_used(),
                           self.sln.num_overloaded_routes())))
