...
- [route-distance-tracking](../implemented/route-distance-tracking.md) -- another per-route quantity maintained
...
- [planning/implemented/route-distance-tracking.md](../implemented/route-distance-tracking.md)
