...
gates its own operator creation on the same cost estimates. [module-structure](../implemented/module-structure.md) for where the estimate would live, and
[route-distance-tracking](../implemented/route-distance-tracking.md), which removes one of the current
...
- [planning/implemented/module-structure.md](../implemented/module-structure.md) -- where per-operator cost estimates would be stored
- [planning/implemented/route-distance-tracking.md](../implemented/route-distance-tracking.md) -- removes one of the per-proposal costs this plan would gate
